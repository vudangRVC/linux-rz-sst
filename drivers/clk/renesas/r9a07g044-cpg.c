...
static const struct {
	...
	.common = {
		...
		DEF_MOD("wdt2_pclk",	R9A07G044_WDT2_PCLK, R9A07G044_CLK_P0,
					0x548, 4, MSTOP(BUS_REG0, BIT(1))),
		DEF_MOD("wdt2_clk",	R9A07G044_WDT2_CLK, R9A07G044_OSCCLK,
					0x548, 5, MSTOP(BUS_REG0, BIT(1))),
		...
		DEF_MOD("isu_aclk",	R9A07G044_ISU_ACLK, R9A07G044_CLK_P1,
					0x55C, 0, MSTOP(BUS_PERI_VIDEO, BIT(4))),
		DEF_MOD("isu_pclk",	R9A07G044_ISU_PCLK, R9A07G044_CLK_P2,
					0x55C, 1, MSTOP(BUS_PERI_VIDEO, BIT(4))),
...
static const struct {
	...
	.common = {
		...
		DEF_MOD("ia55_clk",	R9A07G054_IA55_CLK, R9A07G054_CLK_P1,
					0x518, 1, MSTOP(BUS_PERI_CPU, BIT(13))),
		DEF_MOD("mhu_pclk",	R9A07G054_MHU_PCLK, R9A07G054_CLK_P0,
					0x51c, 0, MSTOP(BUS_PERI_CPU, BIT(14))),
		...
		DEF_MOD("mtu_x_mck",	R9A07G054_MTU_X_MCK_MTU3, R9A07G054_CLK_P0,
					0x538, 0, MSTOP(BUS_MCPU1, BIT(2))),
		DEF_MOD("poe3",		R9A07G054_POE3_CLKM_POE, R9A07G054_CLK_P0,
					0x53c, 0, MSTOP(BUS_MCPU1, BIT(9))),
		...
		DEF_MOD("wdt1_clk",	R9A07G054_WDT1_CLK, R9A07G054_OSCCLK,
					0x548, 3, MSTOP(BUS_REG0, BIT(3))),
		DEF_MOD("wdt2_pclk",	R9A07G054_WDT2_PCLK, R9A07G054_CLK_P0,
					0x548, 4, MSTOP(BUS_REG0, BIT(1))),
		DEF_MOD("wdt2_clk",	R9A07G054_WDT2_CLK, R9A07G054_OSCCLK,
					0x548, 5, MSTOP(BUS_REG0, BIT(1))),
		...
		DEF_MOD("cru_aclk",	R9A07G054_CRU_ACLK, R9A07G054_CLK_M0,
					0x564, 3, MSTOP(BUS_PERI_VIDEO, BIT(3))),
		DEF_MOD("isu_aclk",	R9A07G054_ISU_ACLK, R9A07G054_CLK_P1,
					0x55C, 0, MSTOP(BUS_PERI_VIDEO, BIT(4))),
		DEF_MOD("isu_pclk",	R9A07G054_ISU_PCLK, R9A07G054_CLK_P2,
					0x55C, 1, MSTOP(BUS_PERI_VIDEO, BIT(4))),
		DEF_MOD("h264_clk_a",	R9A07G054_H264_CLK_A, R9A07G054_CLK_M0,
					0x560, 0, 0),
		DEF_MOD("h264_clk_p",	R9A07G054_H264_CLK_P, R9A07G054_CLK_ZT,
					0x560, 0, 0),
		...
		DEF_MOD("lcdc_clk_d",	R9A07G054_LCDC_CLK_D, R9A07G054_CLK_M3,
					0x56c, 1, MSTOP(BUS_PERI_VIDEO, BIT(9))),
		DEF_MOD("cm33_clkin_v2l",   R9A07G054_CM33_CLKIN, R9A07G054_CLK_I2,
					0x504, 0, 0),
		DEF_MOD("cm33_tsclk_v2l",   R9A07G054_CM33_TSCLK, R9A07G054_OSCCLK,
					0x504, 1, 0),
...
const struct rzg2l_cpg_info r9a07g044_cpg_info = {
	...
	/* Module Clocks */
	.mod_clks = rzg2l_mod_clks.common,
	.num_mod_clks = ARRAY_SIZE(rzg2l_mod_clks.common),
...
const struct rzg2l_cpg_info r9a07g054_cpg_info = {
	...
	/* Module Clocks */
	.mod_clks = rzv2l_mod_clks.common,
	.num_mod_clks = ARRAY_SIZE(rzv2l_mod_clks.common) + ARRAY_SIZE(rzv2l_mod_clks.drp),
	...
	/* Resets */
	.resets = r9a07g044_resets,
	.num_resets = R9A07G054_CM33_MISCRESETN + 1,
