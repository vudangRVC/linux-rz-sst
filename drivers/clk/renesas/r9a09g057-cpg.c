...
static const struct cpg_core_clk r9a09g057_core_clks[] __initconst = {
	...
	DEF_PLL(".plldrp", CLK_PLLDRP, CLK_QEXTAL, PLLDRP),
	...
	DEF_CSDIV(".pllcm33_adc_pclk", CLK_PLLCM33_ADC_PCLK, CLK_PLLCM33_DIV2, CSDIV1_DIVCTL0_NO_MON, dtable_8_10),
	DEF_FIXED(".pllcm33_adc_pclk_div2", CLK_PLLCM33_ADC_PCLK_DIV2, CLK_PLLCM33_ADC_PCLK, 1, 2),
	DEF_SDIV(".pllcm33_adc_adclk", CLK_PLLCM33_ADC_ADCLK, CLK_PLLCM33_ADC_PCLK, CSDIV1_DIVCTL1_NO_MON, dtable_2_16),
	DEF_DDIV(".pllcm33_gear", CLK_PLLCM33_GEAR, CLK_PLLCM33_DIV4, CDDIVx_DIVCTLy(0, 1, 3), dtable_2_64),
	DEF_SMUX(".smux2_xspi_clk0", CLK_SMUX2_XSPI_CLK0, SSELx_SELCTLy(1, 2), smux2_xspi_clk0),
	DEF_SMUX(".smux2_xspi_clk1", CLK_SMUX2_XSPI_CLK1, SSELx_SELCTLy(1, 3), smux2_xspi_clk1),
	DEF_CSDIV(".pllcm33_xspi", CLK_PLLCM33_XSPI, CLK_SMUX2_XSPI_CLK1, CSDIV0_DIVCTL3_NO_MON,
		  dtable_2_16),
	...
	DEF_CSDIV(".plleth_gbe0", CLK_CSDIV_PLLETH_GBE0,
		  CLK_PLLETH_DIV_250_FIX, CSDIV0_DIVCTL0_NO_MON, dtable_2_100),
	DEF_CSDIV(".plleth_gbe1", CLK_CSDIV_PLLETH_GBE1,
		  CLK_PLLETH_DIV_250_FIX, CSDIV0_DIVCTL1_NO_MON, dtable_2_100),
	DEF_SMUX(".smux2_gbe0_txclk", CLK_SMUX2_GBE0_TXCLK, SSELx_SELCTLy(0, 2), smux2_gbe0_txclk),
	DEF_SMUX(".smux2_gbe0_rxclk", CLK_SMUX2_GBE0_RXCLK, SSELx_SELCTLy(0, 3), smux2_gbe0_rxclk),
	DEF_SMUX(".smux2_gbe1_txclk", CLK_SMUX2_GBE1_TXCLK, SSELx_SELCTLy(1, 0), smux2_gbe1_txclk),
	DEF_SMUX(".smux2_gbe1_rxclk", CLK_SMUX2_GBE1_RXCLK, SSELx_SELCTLy(1, 1), smux2_gbe1_rxclk),

	DEF_SDIV(".plleth_lpclk", CLK_PLLETH_LPCLK, CLK_PLLETH_DIV_250_FIX,
...
static const struct rzv2h_mod_clk r9a09g057_mod_clks[] __initconst = {
	DEF_MOD_CRITICAL("dmac_0_aclk",		CLK_PLLCM33_GEAR, 0, 0, 0, 0,
						BUS_MSTOP(5, BIT(9))),
	DEF_MOD_CRITICAL("dmac_1_aclk",		CLK_PLLDTY_ACPU_DIV2, 0, 1, 0, 1,
						BUS_MSTOP(3, BIT(2))),
	DEF_MOD_CRITICAL("dmac_2_aclk",		CLK_PLLDTY_ACPU_DIV2, 0, 2, 0, 2,
						BUS_MSTOP(3, BIT(3))),
	DEF_MOD_CRITICAL("dmac_3_aclk",		CLK_PLLDTY_RCPU_DIV4, 0, 3, 0, 3,
						BUS_MSTOP(10, BIT(11))),
	DEF_MOD_CRITICAL("dmac_4_aclk",		CLK_PLLDTY_RCPU_DIV4, 0, 4, 0, 4,
						BUS_MSTOP(10, BIT(12))),
	...
	DEF_MOD("gpt_1_pclk_sfr",		CLK_PLLCLN_DIV8, 3, 2, 1, 18,
						BUS_MSTOP(6, BIT(12))),
	DEF_MOD("cmtw_0_clkm",			CLK_PLLCM33_DIV32, 3, 11, 1, 27,
						BUS_MSTOP(3, BIT(15))),
	DEF_MOD("cmtw_1_clkm",			CLK_PLLCM33_DIV32, 3, 12, 1, 28,
						BUS_MSTOP(4, BIT(0))),
	DEF_MOD("cmtw_2_clkm",			CLK_PLLCM33_DIV32, 3, 13, 1, 29,
						BUS_MSTOP(4, BIT(1))),
	DEF_MOD("cmtw_3_clkm",			CLK_PLLCM33_DIV32, 3, 14, 1, 30,
						BUS_MSTOP(4, BIT(2))),
	DEF_MOD("cmtw_4_clkm",			CLK_PLLCLN_DIV32, 3, 15, 1, 31,
						BUS_MSTOP(5, BIT(15))),
	DEF_MOD("cmtw_5_clkm",			CLK_PLLCLN_DIV32, 4, 0, 2, 0,
						BUS_MSTOP(6, BIT(0))),
	DEF_MOD("cmtw_6_clkm",			CLK_PLLCLN_DIV32, 4, 1, 2, 1,
						BUS_MSTOP(6, BIT(1))),
	...
	DEF_MOD("rspi_2_tclk",			CLK_PLLCLN_DIV8, 5, 12, 2, 28,
						BUS_MSTOP(11, BIT(2))),
	DEF_MOD("rsci_0_pclk",			CLK_PLLCM33_DIV16, 5, 13, 2, 29,
						BUS_MSTOP(11, BIT(3))),
	DEF_MOD("rsci_0_tclk",			CLK_PLLCM33_DIV16, 5, 14, 2, 30,
						BUS_MSTOP(11, BIT(3))),
	DEF_MOD("rsci_0_ps_ps3_n",		CLK_PLLCLN_DIV1024, 5, 15, 2, 31,
						BUS_MSTOP(11, BIT(3))),
	DEF_MOD("rsci_0_ps_ps2_n",		CLK_PLLCLN_DIV256, 6, 0, 3, 0,
						BUS_MSTOP(11, BIT(3))),
	DEF_MOD("rsci_0_ps_ps1_n",		CLK_PLLCLN_DIV64, 6, 1, 3, 1,
						BUS_MSTOP(11, BIT(3))),
	DEF_MOD("rsci_1_pclk",			CLK_PLLCM33_DIV16, 6, 2, 3, 2,
						BUS_MSTOP(11, BIT(4))),
	DEF_MOD("rsci_1_tclk",			CLK_PLLCM33_DIV16, 6, 3, 3, 3,
						BUS_MSTOP(11, BIT(4))),
	DEF_MOD("rsci_1_ps_ps3_n",		CLK_PLLCLN_DIV1024, 6, 4, 3, 4,
						BUS_MSTOP(11, BIT(4))),
	DEF_MOD("rsci_1_ps_ps2_n",		CLK_PLLCLN_DIV256, 6, 5, 3, 5,
						BUS_MSTOP(11, BIT(4))),
	DEF_MOD("rsci_1_ps_ps1_n",		CLK_PLLCLN_DIV64, 6, 6, 3, 6,
						BUS_MSTOP(11, BIT(4))),
	DEF_MOD("rsci_2_pclk",			CLK_PLLCM33_DIV16, 6, 7, 3, 7,
						BUS_MSTOP(11, BIT(5))),
	DEF_MOD("rsci_2_tclk",			CLK_PLLCM33_DIV16, 6, 8, 3, 8,
						BUS_MSTOP(11, BIT(5))),
	DEF_MOD("rsci_2_ps_ps3_n",		CLK_PLLCLN_DIV1024, 6, 9, 3, 9,
						BUS_MSTOP(11, BIT(5))),
	DEF_MOD("rsci_2_ps_ps2_n",		CLK_PLLCLN_DIV256, 6, 10, 3, 10,
						BUS_MSTOP(11, BIT(5))),
	DEF_MOD("rsci_2_ps_ps1_n",		CLK_PLLCLN_DIV64, 6, 11, 3, 11,
						BUS_MSTOP(11, BIT(5))),
	DEF_MOD("rsci_3_pclk",			CLK_PLLCM33_DIV16, 6, 12, 3, 12,
						BUS_MSTOP(11, BIT(6))),
	DEF_MOD("rsci_3_tclk",			CLK_PLLCM33_DIV16, 6, 13, 3, 13,
						BUS_MSTOP(11, BIT(6))),
	DEF_MOD("rsci_3_ps_ps3_n",		CLK_PLLCLN_DIV1024, 6, 14, 3, 14,
						BUS_MSTOP(11, BIT(6))),
	DEF_MOD("rsci_3_ps_ps2_n",		CLK_PLLCLN_DIV256, 6, 15, 3, 15,
						BUS_MSTOP(11, BIT(6))),
	DEF_MOD("rsci_3_ps_ps1_n",		CLK_PLLCLN_DIV64, 7, 0, 3, 16,
						BUS_MSTOP(11, BIT(6))),
	DEF_MOD("rsci_4_pclk",			CLK_PLLCM33_DIV16, 7, 1, 3, 17,
						BUS_MSTOP(11, BIT(7))),
	DEF_MOD("rsci_4_tclk",			CLK_PLLCM33_DIV16, 7, 2, 3, 18,
						BUS_MSTOP(11, BIT(7))),
	DEF_MOD("rsci_4_ps_ps3_n",		CLK_PLLCLN_DIV1024, 7, 3, 3, 19,
						BUS_MSTOP(11, BIT(7))),
	DEF_MOD("rsci_4_ps_ps2_n",		CLK_PLLCLN_DIV256, 7, 4, 3, 20,
						BUS_MSTOP(11, BIT(7))),
	DEF_MOD("rsci_4_ps_ps1_n",		CLK_PLLCLN_DIV64, 7, 5, 3, 21,
						BUS_MSTOP(11, BIT(7))),
	DEF_MOD("rsci_5_pclk",			CLK_PLLCM33_DIV16, 7, 6, 3, 22,
						BUS_MSTOP(11, BIT(8))),
	DEF_MOD("rsci_5_tclk",			CLK_PLLCM33_DIV16, 7, 7, 3, 23,
						BUS_MSTOP(11, BIT(8))),
	DEF_MOD("rsci_5_ps_ps3_n",		CLK_PLLCLN_DIV1024, 7, 8, 3, 24,
						BUS_MSTOP(11, BIT(8))),
	DEF_MOD("rsci_5_ps_ps2_n",		CLK_PLLCLN_DIV256, 7, 9, 3, 25,
						BUS_MSTOP(11, BIT(8))),
	DEF_MOD("rsci_5_ps_ps1_n",		CLK_PLLCLN_DIV64, 7, 10, 3, 26,
						BUS_MSTOP(11, BIT(8))),
	DEF_MOD("rsci_6_pclk",			CLK_PLLCM33_DIV16, 7, 11, 3, 27,
						BUS_MSTOP(11, BIT(9))),
	DEF_MOD("rsci_6_tclk",			CLK_PLLCM33_DIV16, 7, 12, 3, 28,
						BUS_MSTOP(11, BIT(9))),
	DEF_MOD("rsci_6_ps_ps3_n",		CLK_PLLCLN_DIV1024, 7, 13, 3, 29,
						BUS_MSTOP(11, BIT(9))),
	DEF_MOD("rsci_6_ps_ps2_n",		CLK_PLLCLN_DIV256, 7, 14, 3, 30,
						BUS_MSTOP(11, BIT(9))),
	DEF_MOD("rsci_6_ps_ps1_n",		CLK_PLLCLN_DIV64, 7, 15, 3, 31,
						BUS_MSTOP(11, BIT(9))),
	DEF_MOD("rsci_7_pclk",			CLK_PLLCM33_DIV16, 8, 0, 4, 0,
						BUS_MSTOP(11, BIT(10))),
	DEF_MOD("rsci_7_tclk",			CLK_PLLCM33_DIV16, 8, 1, 4, 1,
						BUS_MSTOP(11, BIT(10))),
	DEF_MOD("rsci_7_ps_ps3_n",		CLK_PLLCLN_DIV1024, 8, 2, 4, 2,
						BUS_MSTOP(11, BIT(10))),
	DEF_MOD("rsci_7_ps_ps2_n",		CLK_PLLCLN_DIV256, 8, 3, 4, 3,
						BUS_MSTOP(11, BIT(10))),
	DEF_MOD("rsci_7_ps_ps1_n",		CLK_PLLCLN_DIV64, 8, 4, 4, 4,
						BUS_MSTOP(11, BIT(10))),
	DEF_MOD("rsci_8_pclk",			CLK_PLLCM33_DIV16, 8, 5, 4, 5,
						BUS_MSTOP(11, BIT(11))),
	DEF_MOD("rsci_8_tclk",			CLK_PLLCM33_DIV16, 8, 6, 4, 6,
						BUS_MSTOP(11, BIT(11))),
	DEF_MOD("rsci_8_ps_ps3_n",		CLK_PLLCLN_DIV1024, 8, 7, 4, 7,
						BUS_MSTOP(11, BIT(11))),
	DEF_MOD("rsci_8_ps_ps2_n",		CLK_PLLCLN_DIV256, 8, 8, 4, 8,
						BUS_MSTOP(11, BIT(11))),
	DEF_MOD("rsci_8_ps_ps1_n",		CLK_PLLCLN_DIV64, 8, 9, 4, 9,
						BUS_MSTOP(11, BIT(11))),
	DEF_MOD("rsci_9_pclk",			CLK_PLLCM33_DIV16, 8, 10, 4, 10,
						BUS_MSTOP(11, BIT(12))),
	DEF_MOD("rsci_9_tclk",			CLK_PLLCM33_DIV16, 8, 11, 4, 11,
						BUS_MSTOP(11, BIT(12))),
	DEF_MOD("rsci_9_ps_ps3_n",		CLK_PLLCLN_DIV1024, 8, 12, 4, 12,
						BUS_MSTOP(11, BIT(12))),
	DEF_MOD("rsci_9_ps_ps2_n",		CLK_PLLCLN_DIV256, 8, 13, 4, 13,
						BUS_MSTOP(11, BIT(12))),
	DEF_MOD("rsci_9_ps_ps1_n",		CLK_PLLCLN_DIV64, 8, 14, 4, 14,
						BUS_MSTOP(11, BIT(12))),
	...
	DEF_MOD("cru_3_pclk",			CLK_PLLDTY_DIV16, 13, 13, 6, 29,
						BUS_MSTOP(9, BIT(7))),
	DEF_MOD("cru_0_m_xi",			CLK_QEXTAL, 13, 14, 6, 30,
						BUS_MSTOP(9, BIT(4))),
	DEF_MOD("cru_1_m_xi",			CLK_QEXTAL, 13, 15, 6, 31,
						BUS_MSTOP(9, BIT(5))),
	DEF_MOD("cru_2_m_xi",			CLK_QEXTAL, 14, 0, 7, 0,
						BUS_MSTOP(9, BIT(6))),
	DEF_MOD("cru_3_m_xi",			CLK_QEXTAL, 14, 1, 7, 1,
						BUS_MSTOP(9, BIT(7))),
	DEF_MOD("isu_0_aclk",			CLK_PLLVDO_ISU, 14, 6, 7, 6,
						BUS_MSTOP(10, BIT(0))),
	DEF_MOD("isu_0_pclk",			CLK_PLLDTY_DIV16, 14, 7, 7, 7,
						BUS_MSTOP(10, BIT(0))),
	DEF_MOD("dsi_0_pclk",			CLK_PLLDTY_DIV16, 14, 8, 7, 8,
						BUS_MSTOP(9, BIT(14))),
	DEF_MOD("dsi_0_aclk",			CLK_PLLDTY_ACPU_DIV2, 14, 9, 7, 9,
						BUS_MSTOP(9, BIT(14))),
	DEF_MOD("dsi_0_vclk",			CLK_PLLDSI_SDIV2, 14, 10, 7, 10,
						BUS_MSTOP(9, BIT(14))),
	DEF_MOD("dsi_0_lpclk",			CLK_PLLETH_LPCLK, 14, 11, 7, 11,
						BUS_MSTOP(9, BIT(15))),
	DEF_MOD("dsi_0_pllrefclk",		CLK_QEXTAL, 14, 12, 7, 12,
						BUS_MSTOP(9, BIT(15))),
	DEF_MOD("lcdc_0_clka",			CLK_PLLDTY_ACPU_DIV2, 14, 13, 7, 13,
						BUS_MSTOP(10, BIT(1))),
	DEF_MOD("lcdc_0_clkp",			CLK_PLLDTY_DIV16, 14, 14, 7, 14,
						BUS_MSTOP(10, BIT(1))),
	DEF_MOD("lcdc_0_clkd",			CLK_PLLDSI_SDIV2, 14, 15, 7, 15,
						BUS_MSTOP(10, BIT(1))),
	...
	DEF_MOD("gpu_0_ace_clk",		CLK_PLLDTY_ACPU_DIV2, 15, 2, 7, 18,
						BUS_MSTOP(3, BIT(4))),
	DEF_MOD("vcd_0_aclk",			CLK_PLLDTY_DIV4, 15, 3, 7, 19,
						BUS_MSTOP(9, BIT(11))),
	DEF_MOD("vcd_0_pclk",			CLK_PLLDTY_DIV8, 15, 4, 7, 20,
						BUS_MSTOP(9, BIT(11))),
	...
	DEF_MOD("adg_0_clk_195m",		CLK_PLLCLN_DIV8, 15, 10, 7, 26,
						BUS_MSTOP(2, BIT(2))),
	DEF_MOD("adg_0_audio_clka",		AUDIO_CLKA, 15, 11, 7, 27,
						BUS_MSTOP(2, BIT(2))),
	DEF_MOD("adg_0_audio_clkb",		AUDIO_CLKB, 15, 12, 7, 28,
						BUS_MSTOP(2, BIT(2))),
	DEF_MOD("adg_0_audio_clkc",		AUDIO_CLKC, 15, 13, 7, 29,
						BUS_MSTOP(2, BIT(2))),
	...
	DEF_MOD("spdif_2_clkp",			CLK_PLLDTY_DIV16, 16, 0, 8, 0,
						BUS_MSTOP(1, BIT(11))),
	DEF_MOD("adc_0_pclk",			CLK_PLLCM33_ADC_PCLK_DIV2, 16, 7, 8, 7,
						BUS_MSTOP(3, BIT(9))),
	DEF_MOD("adc_0_adclk",			CLK_PLLCM33_ADC_ADCLK, 16, 8, 8, 8,
						BUS_MSTOP(3, BIT(9))),
...
static const struct rzv2h_reset r9a09g057_resets[] __initconst = {
	...
	DEF_RST(6, 5, 2, 22),		/* CMTW_0_RST_M */
	DEF_RST(6, 6, 2, 23),		/* CMTW_1_RST_M */
	DEF_RST(6, 7, 2, 24),		/* CMTW_2_RST_M */
	DEF_RST(6, 8, 2, 25),		/* CMTW_3_RST_M */
	DEF_RST(6, 9, 2, 26),		/* CMTW_4_RST_M */
	DEF_RST(6, 10, 2, 27),		/* CMTW_5_RST_M */
	DEF_RST(6, 11, 2, 28),		/* CMTW_6_RST_M */
	DEF_RST(6, 12, 2, 29),		/* CMTW_7_RST_M */
	...
	DEF_RST(8, 1, 3, 18),		/* RSCI_0_PRESETN */
	DEF_RST(8, 2, 3, 19),		/* RSCI_0_TRESETN */
	DEF_RST(8, 3, 3, 20),		/* RSCI_1_PRESETN */
	DEF_RST(8, 4, 3, 21),		/* RSCI_1_TRESETN */
	DEF_RST(8, 5, 3, 22),		/* RSCI_2_PRESETN */
	DEF_RST(8, 6, 3, 23),		/* RSCI_2_TRESETN */
	DEF_RST(8, 7, 3, 24),		/* RSCI_3_PRESETN */
	DEF_RST(8, 8, 3, 25),		/* RSCI_3_TRESETN */
	DEF_RST(8, 9, 3, 26),		/* RSCI_4_PRESETN */
	DEF_RST(8, 10, 3, 27),		/* RSCI_4_TRESETN */
	DEF_RST(8, 11, 3, 28),		/* RSCI_5_PRESETN */
	DEF_RST(8, 12, 3, 29),		/* RSCI_5_TRESETN */
	DEF_RST(8, 13, 3, 30),		/* RSCI_6_PRESETN */
	DEF_RST(8, 14, 3, 31),		/* RSCI_6_TRESETN */
	DEF_RST(8, 15, 4, 0),		/* RSCI_7_PRESETN */
	DEF_RST(9, 0, 4, 1),		/* RSCI_7_TRESETN */
	DEF_RST(9, 1, 4, 2),		/* RSCI_8_PRESETN */
	DEF_RST(9, 2, 4, 3),		/* RSCI_8_TRESETN */
	DEF_RST(9, 3, 4, 4),		/* RSCI_9_PRESETN */
	DEF_RST(9, 4, 4, 5),		/* RSCI_9_TRESETN */
	...
	DEF_RST(13, 5, 6, 6),		/* ISU_0_ARESETN */
	DEF_RST(13, 6, 6, 7),		/* ISU_0_PRESETN */
	...
	DEF_RST(14, 0, 6, 17),		/* VCD_0_RESETN */
	...
	DEF_RST(15, 1, 7, 2),		/* SPDIF_2_RST */
	DEF_RST(15, 6, 7, 7),		/* ADC_0_ADRST_N */
