#ifndef _VVCAM_AR1335_REGS_1080P_H_
#define _VVCAM_AR1335_REGS_1080P_H_

#include "vvsensor.h"

/* 1080P30 RAW10 */
static struct vvcam_sccb_data_s ar1335_init_setting_1080p[] = {
    ...
    {0x0306, 0xB7B7}, /* PLL_MULTIPLIER	MCLK,24M */
