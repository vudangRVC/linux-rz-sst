#ifndef _VVCAM_AR1335_REGS_12MP_H_
#define _VVCAM_AR1335_REGS_12MP_H_

#include "vvsensor.h"

/* 4096x2160@30fps RAW10 */
static struct vvcam_sccb_data_s ar1335_init_setting_12MP[] = {
    ...
    {0x0344, 0x0048}, /* X_ADDR_START */
    {0x0348, 0x1047}, /* X_ADDR_END */
    {0x0346, 0x0004}, /* Y_ADDR_START, 0x01F0(2160), 0x4(3072) */
    {0x034A, 0x0C03}, /* Y_ADDR_END, 0x0A5F(2160+Y_ADDR_START-1), 0xC03(3072+Y_ADDR_START-1) */
    {0x034E, 0x0C00}, /* Y_OUTPUT_SIZE, 0x0870(2160), 0xC00(3072) */
    {0x034C, 0x1000}, /* X_OUTPUT_SIZE */
    ...
    {0x0340, 0x0C90}, /* FRAME_LENGTH_LINES */
    {0x0202, 0x0C90}, /* COARSE_INTEGRATION_TIME */
    {0x0342, 0x1230}, /* LINE_LENGTH_PCK */
    {0x0340, 0x0C90}, /* FRAME_LENGTH_LINES */
    {0x0202, 0x0C90}, /* COARSE_INTEGRATION_TIME */
    {0x30FE, 0x0060}, /* CTREE_OFF */
